...
var script$1 = {
  ...
  methods: {
    ...
    startMove: function startMove(item, e) {
      this.areas.forEach(function (elem) {
        elem.selected = false;
      });
      item.selected = true;
      this.move = true;
...
var __vue_scope_id__$1 = "data-v-5beed808";
/* module identifier */
